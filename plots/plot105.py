...
samples.saveAsText(chaindir + '/.VM_P105_TMP1')
# --------------------------------------------------------------------------------
...
samples.addDerived(p.s8omegamp5/0.5477225575,name='SS8',label='{S_8}')
samples.addDerived(p.mnu,name='mnu2',label='{\\sum m_\\nu}', range=[0.06,0.7])
samples.saveAsText(chaindir + '/.VM_P105_TMP2')
# --------------------------------------------------------------------------------
...
samples.addDerived(p.s8omegamp5/0.5477225575,name='SS8',label='{S_8}')
samples.addDerived(p.mnu,name='mnu2',label='{\\sum m_\\nu}', range=[0.06,0.7])
samples.saveAsText(chaindir + '/.VM_P105_TMP3')
# --------------------------------------------------------------------------------
# --------------------------------------------------------------------------------
...
samples.addDerived(p.s8omegamp5/0.5477225575,name='SS8',label='{S_8}')
samples.addDerived(p.mnu,name='mnu2',label='{\\sum m_\\nu}', range=[0.06,0.7])
samples.saveAsText(chaindir + '/.VM_P105_TMP4')
# --------------------------------------------------------------------------------
...
samples.addDerived(p.s8omegamp5/0.5477225575,name='SS8',label='{S_8}')
samples.addDerived(p.mnu,name='mnu2',label='{\\sum m_\\nu}', range=[0.06,0.7])
samples.saveAsText(chaindir + '/.VM_P105_TMP5')
# --------------------------------------------------------------------------------
...
samples.addDerived(p.s8omegamp5/0.5477225575,name='SS8',label='{S_8}')
samples.addDerived(p.mnu,name='mnu2',label='{\\sum m_\\nu}', range=[0.06,0.7])
samples.saveAsText(chaindir + '/.VM_P105_TMP6')
# --------------------------------------------------------------------------------
# --------------------------------------------------------------------------------
...
samples.addDerived(p.s8omegamp5/0.5477225575,name='SS8',label='{S_8}')
samples.addDerived(p.mnu,name='mnu2',label='{\\sum m_\\nu}', range=[0.06,0.7])
samples.saveAsText(chaindir + '/.VM_P105_TMP7')
# --------------------------------------------------------------------------------
...
samples.addDerived(p.s8omegamp5/0.5477225575,name='SS8',label='{S_8}')
samples.addDerived(p.mnu,name='mnu2',label='{\\sum m_\\nu}', range=[0.06,0.7])
samples.saveAsText(chaindir + '/.VM_P105_TMP8')
# --------------------------------------------------------------------------------
...
samples.addDerived(p.s8omegamp5/0.5477225575,name='SS8',label='{S_8}')
samples.addDerived(p.mnu,name='mnu2',label='{\\sum m_\\nu}', range=[0.06,0.7])
samples.saveAsText(chaindir + '/.VM_P105_TMP9')
# --------------------------------------------------------------------------------
...
g.plots_1d(
  [ 
    chaindir + '/.VM_P105_TMP1', 
    chaindir + '/.VM_P105_TMP4', 
    chaindir + '/.VM_P105_TMP7', 
    chaindir + '/.VM_P105_TMP3',
    chaindir + '/.VM_P105_TMP6',
    chaindir + '/.VM_P105_TMP9'
  ],
  params=[u'mnu2'],
  line_args=[
...
# --------------------------------------------------------------------------------
samples        = loadMCSamples(chaindir + '/.VM_P105_TMP3',settings=analysissettings2)
stats          = samples.getMargeStats()
sampleAnalyser = gplot.MCSampleAnalysis(chaindir,settings=analysissettings2)
lims           = stats.parWithName('mnu2').limits
density        = sampleAnalyser.get_density(chaindir + '/.VM_P105_TMP3', param='mnu2')
...
# --------------------------------------------------------------------------------
samples        = loadMCSamples(chaindir + '/.VM_P105_TMP6',settings=analysissettings2)
stats          = samples.getMargeStats()
sampleAnalyser = gplot.MCSampleAnalysis(chaindir,settings=analysissettings2)
lims           = stats.parWithName('mnu2').limits
density        = sampleAnalyser.get_density(chaindir + '/.VM_P105_TMP6', param='mnu2')
...
plt.gca().fill_between(tmp0, 0, tmp1, facecolor='indigo',alpha=0.25) 
# --------------------------------------------------------------------------------
samples        = loadMCSamples(chaindir + '/.VM_P105_TMP9',settings=analysissettings2)
stats          = samples.getMargeStats()
sampleAnalyser = gplot.MCSampleAnalysis(chaindir,settings=analysissettings2)
lims           = stats.parWithName('mnu2').limits
density        = sampleAnalyser.get_density(chaindir + '/.VM_P105_TMP9', param='mnu2')
...
plt.gca().fill_between(tmp0, 0, tmp1, facecolor='indigo',alpha=0.25) 
# --------------------------------------------------------------------------------
samples        = loadMCSamples(chaindir + '/.VM_P105_TMP1',settings=analysissettings2)
stats          = samples.getMargeStats()
sampleAnalyser = gplot.MCSampleAnalysis(chaindir,settings=analysissettings2)
lims           = stats.parWithName('mnu2').limits
density        = sampleAnalyser.get_density(chaindir + '/.VM_P105_TMP1', param='mnu2')
...
# --------------------------------------------------------------------------------
samples        = loadMCSamples(chaindir + '/.VM_P105_TMP4',settings=analysissettings2)
stats          = samples.getMargeStats()
sampleAnalyser = gplot.MCSampleAnalysis(chaindir,settings=analysissettings2)
lims           = stats.parWithName('mnu2').limits
density        = sampleAnalyser.get_density(chaindir + '/.VM_P105_TMP4', param='mnu2')
...
plt.gca().fill_between(tmp0, 0, tmp1, facecolor='lightcoral',alpha=0.5) 
# --------------------------------------------------------------------------------
samples        = loadMCSamples(chaindir + '/.VM_P105_TMP7',settings=analysissettings2)
stats          = samples.getMargeStats()
sampleAnalyser = gplot.MCSampleAnalysis(chaindir,settings=analysissettings2)
lims           = stats.parWithName('mnu2').limits
density        = sampleAnalyser.get_density(chaindir + '/.VM_P105_TMP7', param='mnu2')
