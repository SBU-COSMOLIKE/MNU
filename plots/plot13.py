...
samples.saveAsText(chaindir + '/.VM_P13_TMP1')
# --------------------------------------------------------------------------------
...
samples.addDerived(p.s8omegamp5/0.5477225575,name='SS8',label='{S_8}')
samples.addDerived(p.mnu,name='mnu2',label='{\\sum m_\\nu}', range=[0.06,0.7])
samples.saveAsText(chaindir + '/.VM_P13_TMP2')
# --------------------------------------------------------------------------------
...
samples.addDerived(p.s8omegamp5/0.5477225575,name='SS8',label='{S_8}')
samples.addDerived(p.mnu,name='mnu2',label='{\\sum m_\\nu}', range=[0.06,0.7])
samples.saveAsText(chaindir + '/.VM_P13_TMP3')
# --------------------------------------------------------------------------------
...
g.plots_1d(
  [ 
    chaindir + '/.VM_P13_TMP1', 
    chaindir + '/.VM_P13_TMP2',
    chaindir + '/.VM_P13_TMP3'
  ],
  params=[u'mnu2'],
  line_args=[
...
g.add_text('Planck low-$\\ell$ TTEE and high-$\\ell$ ($35<\\ell<648$) TTTEEE + BAO + SN + ACTPol-DR4 TTTEEE', 
  x=0.015, 
  y=0.95,
  fontsize=7.5,
