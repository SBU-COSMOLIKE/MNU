...
samples.addDerived(p.s8omegamp5/0.5477225575,name='SS8',label='{S_8}')
samples.addDerived(p.mnu,name='mnu2',label='{\\sum m_\\nu}', range=[0.06,0.7])
samples.saveAsText(chaindir + '/.VM_P6_TMP2')
# --------------------------------------------------------------------------------
...
samples.addDerived(p.s8omegamp5/0.5477225575,name='SS8',label='{S_8}')
samples.addDerived(p.mnu,name='mnu2',label='{\\sum m_\\nu}', range=[0.06,0.7])
samples.saveAsText(chaindir + '/.VM_P6_TMP3')
# --------------------------------------------------------------------------------
...
g.add_text('Planck low-$\\ell$ TTEE and high-$\\ell$ ($35<\\ell<648$) TTTEEE and $\\phi\\phi$ + BAO + SN + SPT-3G TTTEEE', 
  x=0.015, 
  y=0.95,
  fontsize=7.5,
