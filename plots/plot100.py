...
# --------------------------------------------------------------------------------
samples        = loadMCSamples(chaindir + '/.VM_P1_TMP3',settings=analysissettings2)
stats          = samples.getMargeStats()
sampleAnalyser = gplot.MCSampleAnalysis(chaindir,settings=analysissettings2)
lims           = stats.parWithName('mnu2').limits
density        = sampleAnalyser.get_density(chaindir + '/.VM_P1_TMP3', param='mnu2')
...
# --------------------------------------------------------------------------------
samples        = loadMCSamples(chaindir + '/.VM_P1_TMP6',settings=analysissettings2)
stats          = samples.getMargeStats()
sampleAnalyser = gplot.MCSampleAnalysis(chaindir,settings=analysissettings2)
lims           = stats.parWithName('mnu2').limits
density        = sampleAnalyser.get_density(chaindir + '/.VM_P1_TMP6', param='mnu2')
...
plt.gca().fill_between(tmp0, 0, tmp1, facecolor='indigo',alpha=0.25) 
# --------------------------------------------------------------------------------
samples        = loadMCSamples(chaindir + '/.VM_P1_TMP9',settings=analysissettings2)
stats          = samples.getMargeStats()
sampleAnalyser = gplot.MCSampleAnalysis(chaindir,settings=analysissettings2)
lims           = stats.parWithName('mnu2').limits
density        = sampleAnalyser.get_density(chaindir + '/.VM_P1_TMP9', param='mnu2')
...
plt.gca().fill_between(tmp0, 0, tmp1, facecolor='indigo',alpha=0.25) 
# --------------------------------------------------------------------------------
samples        = loadMCSamples(chaindir + '/.VM_P1_TMP1',settings=analysissettings2)
stats          = samples.getMargeStats()
sampleAnalyser = gplot.MCSampleAnalysis(chaindir,settings=analysissettings2)
lims           = stats.parWithName('mnu2').limits
density        = sampleAnalyser.get_density(chaindir + '/.VM_P1_TMP1', param='mnu2')
...
# --------------------------------------------------------------------------------
samples        = loadMCSamples(chaindir + '/.VM_P1_TMP4',settings=analysissettings2)
stats          = samples.getMargeStats()
sampleAnalyser = gplot.MCSampleAnalysis(chaindir,settings=analysissettings2)
lims           = stats.parWithName('mnu2').limits
density        = sampleAnalyser.get_density(chaindir + '/.VM_P1_TMP4', param='mnu2')
...
plt.gca().fill_between(tmp0, 0, tmp1, facecolor='lightcoral',alpha=0.5) 
# --------------------------------------------------------------------------------
samples        = loadMCSamples(chaindir + '/.VM_P1_TMP7',settings=analysissettings2)
stats          = samples.getMargeStats()
sampleAnalyser = gplot.MCSampleAnalysis(chaindir,settings=analysissettings2)
lims           = stats.parWithName('mnu2').limits
density        = sampleAnalyser.get_density(chaindir + '/.VM_P1_TMP7', param='mnu2')
